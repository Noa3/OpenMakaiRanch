...
/// <summary>
/// Applies the shared account-wide keyboard/controller bindings when a playable world is ready.
/// The public keyboard table is retained for smoke-test/backwards compatibility; runtime mapping is
/// owned by InputBindingService so options remapping and world controls can never drift apart.
/// </summary>
