...
public partial class WorldTutorialController : Control
{
    ...
    private static readonly TutorialStep[] Steps =
    {
        ...
        new("world_camera", "Look around",
            "Hold the right mouse button and move the mouse to orbit the camera. Use the wheel to zoom close for inspection, press V for first-person, and R to recenter. Camera collision keeps the view in front of walls.",
            "RMB = look  •  Wheel = zoom  •  V = first-person  •  R = recenter"),
