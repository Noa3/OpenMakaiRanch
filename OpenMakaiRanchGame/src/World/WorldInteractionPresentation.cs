...
/// <summary>
/// Presentation-only snapshot of the closest thing the player can interact with. Activation remains
/// owned by RanchGreyboxController/TownWorldController so UI feedback cannot duplicate gameplay.
/// </summary>
