...
public sealed class DataRegistry
{
	...
	private void SeedItems()
	{
		...
		Add(new ItemDefinition { Id = "trail_hat", DisplayName = "Trail Hat", Category = ItemCategory.Equipment, Price = 70, Description = "A wide-brimmed hat for sun protection on long expeditions.", Slot = EquipmentSlot.Head, BonusMaxHp = 8, BonusMorale = 2 });
	}
