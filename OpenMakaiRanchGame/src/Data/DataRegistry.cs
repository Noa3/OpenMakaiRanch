...
public sealed class DataRegistry
{
	...
	private void SeedItems()
	{
		...
		Add(new ItemDefinition { Id = "lactation_drug", DisplayName = "Lactation Drug", Category = ItemCategory.Consumable, Price = 45, Description = "A milky drug that grants a milk constitution, boosting daily milk output." });
		Add(new ItemDefinition { Id = "mana_infusion_drug", DisplayName = "Mana Infusion Drug", Category = ItemCategory.Consumable, Price = 90, Description = "Enchants milk with mana, raising milk quality and price." });
		Add(new ItemDefinition { Id = "mana_shackle", DisplayName = "Mana Shackles", Category = ItemCategory.Material, Price = 120, Description = "Arcane restraints used to secure captured wanderers. Consumed per capture." });
		...
		Add(new ItemDefinition { Id = "miko_robe_ex", DisplayName = "Miko Shrine Maiden Robe (巫女服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A complete shrine maiden outfit set from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "sister_robe_ex", DisplayName = "Sister Costume Robe (シスター衣装)", Category = ItemCategory.Equipment, Price = 100000, Description = "A complete nun costume from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "cowgirl_costume", DisplayName = "Cowgirl Costume (乳牛衣装)", Category = ItemCategory.Equipment, Price = 1000, Description = "A cowgirl costume set from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.CowGirl });
		Add(new ItemDefinition { Id = "micro_cowgirl_costume", DisplayName = "Micro Bikini Cowgirl (マイクロビキニ乳牛)", Category = ItemCategory.Equipment, Price = 1000, Description = "A micro bikini cowgirl costume from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.CowGirl });
		Add(new ItemDefinition { Id = "hole_cowgirl_costume", DisplayName = "Holey Cowgirl (穴空き乳牛)", Category = ItemCategory.Equipment, Price = 1000, Description = "A cowgirl outfit with strategic holes from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.CowGirl });
		Add(new ItemDefinition { Id = "maid_costume", DisplayName = "Maid Outfit (メイド服)", Category = ItemCategory.Equipment, Price = 20000, Description = "A standalone maid outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid });
		Add(new ItemDefinition { Id = "nursing_maid_costume", DisplayName = "Nursing Maid (授乳メイド)", Category = ItemCategory.Equipment, Price = 1000, Description = "A nursing maid outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid });
		Add(new ItemDefinition { Id = "fabric_patch", DisplayName = "Clothing Repair Cloth (衣服補修布)", Category = ItemCategory.Material, Price = 1000, Description = "Fabric for repairing clothes.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "cloth_clothes", DisplayName = "Cloth Clothes (布の服)", Category = ItemCategory.Equipment, Price = 5000, Description = "Simple cloth garments.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "dancer_costume", DisplayName = "Dancer's Outfit (踊り子の衣装)", Category = ItemCategory.Equipment, Price = 30000, Description = "An alluring dancer costume from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "reverse_bunny_costume", DisplayName = "Reverse Bunny (逆バニー服)", Category = ItemCategory.Equipment, Price = 20000, Description = "A reverse bunny costume from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Bunny });
		Add(new ItemDefinition { Id = "corrupt_miko", DisplayName = "Corrupt Shrine Maiden (淫乱巫女服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted shrine maiden outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "corrupt_sister", DisplayName = "Corrupt Nun Costume (淫乱シスター服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted nun costume from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "corrupt_maid", DisplayName = "Corrupt Maid (淫乱メイド服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted maid outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid });
		Add(new ItemDefinition { Id = "traveler_clothes", DisplayName = "Traveler's Clothes (旅人の服)", Category = ItemCategory.Equipment, Price = 10000, Description = "Simple traveler garments from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "noble_clothes", DisplayName = "Noble's Attire (貴族服)", Category = ItemCategory.Equipment, Price = 80000, Description = "Elegant noble attire from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Formal });
		Add(new ItemDefinition { Id = "monk_robe", DisplayName = "Monk's Robe (修道服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A simple monk robe from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "combat_miko_costume", DisplayName = "Combat Shrine Maiden (戦闘用巫女服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready shrine maiden outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist, BonusMaxHp = 15, BonusCombatSkill = 2 });
		Add(new ItemDefinition { Id = "combat_sister_costume", DisplayName = "Combat Nun (戦闘用シスター服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready nun outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist, BonusMaxHp = 15, BonusCombatSkill = 1, BonusCraftSkill = 1 });
		Add(new ItemDefinition { Id = "combat_maid_costume", DisplayName = "Combat Maid (戦闘用メイド服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready maid outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid, BonusCraftSkill = 2 });
		Add(new ItemDefinition { Id = "mage_academy_uniform", DisplayName = "Magic Academy Uniform (魔術学園制服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A magic academy uniform from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.School });
		Add(new ItemDefinition { Id = "prisoner_uniform_costume", DisplayName = "Prisoner Uniform (囚人服)", Category = ItemCategory.Equipment, Price = 5000, Description = "A basic prisoner uniform from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Slave });
		Add(new ItemDefinition { Id = "gothic_lolita_costume", DisplayName = "Gothic Lolita (ゴスロリ衣装)", Category = ItemCategory.Equipment, Price = 50000, Description = "A gothic lolita fashion outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Formal });
		Add(new ItemDefinition { Id = "nurse_costume", DisplayName = "Nurse Outfit (ナース服)", Category = ItemCategory.Equipment, Price = 20000, Description = "A nurse outfit from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Nurse });
		Add(new ItemDefinition { Id = "sailor_costume", DisplayName = "Sailor Uniform (セーラー服)", Category = ItemCategory.Equipment, Price = 10000, Description = "A classic sailor-style uniform from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.School });
		Add(new ItemDefinition { Id = "blazer_costume", DisplayName = "Blazer Uniform (ブレザー制服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A formal blazer uniform from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.School });
		Add(new ItemDefinition { Id = "military_uniform", DisplayName = "Military Uniform (軍服)", Category = ItemCategory.Equipment, Price = 100000, Description = "A military-style uniform from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Tactical });
		Add(new ItemDefinition { Id = "tentacle_outfit", DisplayName = "Tentacle Suit (触手服)", Category = ItemCategory.Equipment, Price = 100000, Description = "A living suit woven from tentacles from the original game.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default, BonusMaxHp = 10, BonusMaxEnergy = 10 });
		Add(new ItemDefinition { Id = "dancer_outfit", DisplayName = "Dancer Outfit (踊り子の衣装)", Category = ItemCategory.Equipment, Price = 30000, Description = "An alluring dancer costume.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "reverse_bunny", DisplayName = "Reverse Bunny Suit (逆バニー服)", Category = ItemCategory.Equipment, Price = 20000, Description = "A reverse bunny costume.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "淫乱巫女服", DisplayName = "Corrupt Shrine Maiden (淫乱巫女服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted shrine maiden outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "淫乱シスター服", DisplayName = "Corrupt Nun Costume (淫乱シスター服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted nun costume.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "淫乱メイド服", DisplayName = "Corrupt Maid Outfit (淫乱メイド服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A corrupted maid outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "traveler_clothes", DisplayName = "Traveler Clothes (旅人の服)", Category = ItemCategory.Equipment, Price = 10000, Description = "Simple traveler garments.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "noble_clothes", DisplayName = "Noble Clothes (貴族服)", Category = ItemCategory.Equipment, Price = 80000, Description = "Elegant noble attire.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "miko_robe", DisplayName = "Shrine Maiden Robe (巫女服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A standalone shrine maiden robe.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "monk_robe", DisplayName = "Monk Robe (修道服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A simple monk robe.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "combat_miko", DisplayName = "Combat Shrine Maiden (戦闘用巫女服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready shrine maiden outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "combat_sister", DisplayName = "Combat Nun (戦闘用シスター服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready nun outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "combat_maid", DisplayName = "Combat Maid (戦闘用メイド服)", Category = ItemCategory.Equipment, Price = 50000, Description = "Battle-ready maid outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "mage_robe", DisplayName = "Magic Academy Uniform (魔術学園制服)", Category = ItemCategory.Equipment, Price = 50000, Description = "A magic academy uniform.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "prisoner_uniform", DisplayName = "Prisoner Uniform (囚人服)", Category = ItemCategory.Equipment, Price = 5000, Description = "A basic prisoner uniform.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "gothic_lolita", DisplayName = "Gothic Lolita (ゴスロリ衣装)", Category = ItemCategory.Equipment, Price = 50000, Description = "A gothic lolita fashion outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "nurse_outfit", DisplayName = "Nurse Outfit (ナース服)", Category = ItemCategory.Equipment, Price = 20000, Description = "A nurse outfit.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "sailor_outfit", DisplayName = "Sailor Uniform (セーラー服)", Category = ItemCategory.Equipment, Price = 10000, Description = "A classic sailor-style uniform.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "blazer_uniform", DisplayName = "Blazer Uniform (ブレザー制服)", Category = ItemCategory.Equipment, Price = 30000, Description = "A formal blazer uniform.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "military_uniform", DisplayName = "Military Uniform (軍服)", Category = ItemCategory.Equipment, Price = 100000, Description = "A military-style uniform.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
		Add(new ItemDefinition { Id = "tentacle_clothes", DisplayName = "Tentacle Suit (触手服)", Category = ItemCategory.Equipment, Price = 100000, Description = "A suit made of living tentacles.", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Default });
	...
	{
		Add(new TalentDefinition { Id = "fast_learner" });
		Add(new TalentDefinition { Id = "klutz" });
		Add(new TalentDefinition { Id = "hospitality_clumsy" });
		Add(new TalentDefinition { Id = "cowardly" });
		Add(new TalentDefinition { Id = "shy" });
		Add(new TalentDefinition { Id = "obedient" });
		Add(new TalentDefinition { Id = "devoted" });
		Add(new TalentDefinition { Id = "proud" });
		Add(new TalentDefinition { Id = "faith" });
		Add(new TalentDefinition { Id = "justice" });
		Add(new TalentDefinition { Id = "steadfast" });
		Add(new TalentDefinition { Id = "honest_to_pleasure" });
		Add(new TalentDefinition { Id = "shameless" });
		Add(new TalentDefinition { Id = "weak_to_pain" });
		Add(new TalentDefinition { Id = "moody" });
		Add(new TalentDefinition { Id = "easily_charmed" });
		Add(new TalentDefinition { Id = "pharmacy_knowledge" });
		Add(new TalentDefinition { Id = "docile" });
		Add(new TalentDefinition { Id = "maternal_instinct" });
		Add(new TalentDefinition { Id = "self_control" });
		Add(new TalentDefinition { Id = "conservative" });
		Add(new TalentDefinition { Id = "dignity" });
		Add(new TalentDefinition { Id = "rebellious" });
		Add(new TalentDefinition { Id = "horns" });
		Add(new TalentDefinition { Id = "male" });
		Add(new TalentDefinition { Id = "owner" });
		Add(new TalentDefinition { Id = "makai_race" });
		Add(new TalentDefinition { Id = "mouth_paradise" });
		Add(new TalentDefinition { Id = "virginity_barrier" });
		Add(new TalentDefinition { Id = "chastity" });
		Add(new TalentDefinition { Id = "virgin" });
		Add(new TalentDefinition { Id = "a_virgin" });
		Add(new TalentDefinition { Id = "m_virgin" });
		Add(new TalentDefinition { Id = "pure" });
		Add(new TalentDefinition { Id = "tsundere" });
		Add(new TalentDefinition { Id = "doesnt_cross_line" });
		Add(new TalentDefinition { Id = "maiden_heart" });
		Add(new TalentDefinition { Id = "denies_pleasure" });
		Add(new TalentDefinition { Id = "jk" });
		Add(new TalentDefinition { Id = "baby_face" });
		Add(new TalentDefinition { Id = "extreme_milk_pressure" });
		Add(new TalentDefinition { Id = "breast_abuse_hatred" });
		Add(new TalentDefinition { Id = "breast_proud" });
		Add(new TalentDefinition { Id = "cleaning_clumsy" });
		Add(new TalentDefinition { Id = "indifferent" });
		Add(new TalentDefinition { Id = "animal_ears" });
		Add(new TalentDefinition { Id = "1", DisplayName = "Ａ処女" });
		Add(new TalentDefinition { Id = "2", DisplayName = "処女結界" });
		Add(new TalentDefinition { Id = "3", DisplayName = "キス未経験" });
		Add(new TalentDefinition { Id = "4", DisplayName = "授乳未経験" });
		Add(new TalentDefinition { Id = "5", DisplayName = "パイズリ未経験" });
		Add(new TalentDefinition { Id = "6", DisplayName = "Ｍ処女" });
		Add(new TalentDefinition { Id = "10", DisplayName = "絶壁" });
		Add(new TalentDefinition { Id = "11", DisplayName = "貧乳" });
		Add(new TalentDefinition { Id = "12", DisplayName = "並乳" });
		Add(new TalentDefinition { Id = "13", DisplayName = "巨乳" });
		Add(new TalentDefinition { Id = "14", DisplayName = "豊乳" });
		Add(new TalentDefinition { Id = "15", DisplayName = "爆乳" });
		Add(new TalentDefinition { Id = "16", DisplayName = "神乳" });
		Add(new TalentDefinition { Id = "17", DisplayName = "魔乳" });
		Add(new TalentDefinition { Id = "18", DisplayName = "超乳" });
		Add(new TalentDefinition { Id = "20", DisplayName = "オトコ" });
		Add(new TalentDefinition { Id = "21", DisplayName = "オーナー" });
		Add(new TalentDefinition { Id = "22", DisplayName = "童貞" });
		Add(new TalentDefinition { Id = "23", DisplayName = "Ａ童貞" });
		Add(new TalentDefinition { Id = "24", DisplayName = "Ｍ童貞" });
		Add(new TalentDefinition { Id = "30", DisplayName = "名器" });
		Add(new TalentDefinition { Id = "31", DisplayName = "Ａ名器" });
		Add(new TalentDefinition { Id = "32", DisplayName = "先天的母乳体質" });
		Add(new TalentDefinition { Id = "33", DisplayName = "おくちまんこ" });
		Add(new TalentDefinition { Id = "34", DisplayName = "極上乳圧" });
		Add(new TalentDefinition { Id = "50", DisplayName = "魔界種族" });
		Add(new TalentDefinition { Id = "51", DisplayName = "天界種族" });
		Add(new TalentDefinition { Id = "52", DisplayName = "神格" });
		Add(new TalentDefinition { Id = "53", DisplayName = "動物耳" });
		Add(new TalentDefinition { Id = "54", DisplayName = "尻尾" });
		Add(new TalentDefinition { Id = "55", DisplayName = "二本角" });
		Add(new TalentDefinition { Id = "56", DisplayName = "エルフ耳" });
		Add(new TalentDefinition { Id = "57", DisplayName = "ハーフリング耳" });
		Add(new TalentDefinition { Id = "70", DisplayName = "魔界適応" });
		Add(new TalentDefinition { Id = "71", DisplayName = "薬毒耐性" });
		Add(new TalentDefinition { Id = "72", DisplayName = "太陽苦手" });
		Add(new TalentDefinition { Id = "73", DisplayName = "猫舌" });
		Add(new TalentDefinition { Id = "74", DisplayName = "ギザ歯" });
		Add(new TalentDefinition { Id = "75", DisplayName = "陥没乳首" });
		Add(new TalentDefinition { Id = "76", DisplayName = "パフィーニップル" });
		Add(new TalentDefinition { Id = "77", DisplayName = "童顔" });
		Add(new TalentDefinition { Id = "100", DisplayName = "痛みに強い" });
		Add(new TalentDefinition { Id = "101", DisplayName = "濡れやすい" });
		Add(new TalentDefinition { Id = "102", DisplayName = "回復早い" });
		Add(new TalentDefinition { Id = "103", DisplayName = "食いしん坊" });
		Add(new TalentDefinition { Id = "104", DisplayName = "習得早い" });
		Add(new TalentDefinition { Id = "105", DisplayName = "動物に好かれる" });
		Add(new TalentDefinition { Id = "106", DisplayName = "汚臭敏感" });
		Add(new TalentDefinition { Id = "107", DisplayName = "中毒しやすい" });
		Add(new TalentDefinition { Id = "150", DisplayName = "痛みに弱い" });
		Add(new TalentDefinition { Id = "151", DisplayName = "濡れにくい" });
		Add(new TalentDefinition { Id = "152", DisplayName = "回復遅い" });
		Add(new TalentDefinition { Id = "153", DisplayName = "少食" });
		Add(new TalentDefinition { Id = "154", DisplayName = "習得遅い" });
		Add(new TalentDefinition { Id = "155", DisplayName = "動物に嫌われる" });
		Add(new TalentDefinition { Id = "156", DisplayName = "汚臭鈍感" });
		Add(new TalentDefinition { Id = "157", DisplayName = "中毒しにくい" });
		Add(new TalentDefinition { Id = "200", DisplayName = "教え上手" });
		Add(new TalentDefinition { Id = "201", DisplayName = "性知識豊富" });
		Add(new TalentDefinition { Id = "210", DisplayName = "調合知識" });
		Add(new TalentDefinition { Id = "211", DisplayName = "工学知識" });
		Add(new TalentDefinition { Id = "212", DisplayName = "淫具知識" });
		Add(new TalentDefinition { Id = "213", DisplayName = "医療知識" });
		Add(new TalentDefinition { Id = "214", DisplayName = "植物知識" });
		Add(new TalentDefinition { Id = "215", DisplayName = "裁縫知識" });
		Add(new TalentDefinition { Id = "220", DisplayName = "煽動" });
		Add(new TalentDefinition { Id = "221", DisplayName = "武装乙女" });
		Add(new TalentDefinition { Id = "250", DisplayName = "教え下手" });
		Add(new TalentDefinition { Id = "251", DisplayName = "性知識乏しい" });
		Add(new TalentDefinition { Id = "260", DisplayName = "運動不足" });
		Add(new TalentDefinition { Id = "261", DisplayName = "虚弱体質" });
		Add(new TalentDefinition { Id = "262", DisplayName = "料理下手" });
		Add(new TalentDefinition { Id = "263", DisplayName = "掃除下手" });
		Add(new TalentDefinition { Id = "264", DisplayName = "接客下手" });
		Add(new TalentDefinition { Id = "265", DisplayName = "音痴" });
		Add(new TalentDefinition { Id = "270", DisplayName = "ドジっ子" });
		Add(new TalentDefinition { Id = "300", DisplayName = "プライド高い" });
		Add(new TalentDefinition { Id = "301", DisplayName = "高慢" });
		Add(new TalentDefinition { Id = "302", DisplayName = "勇敢" });
		Add(new TalentDefinition { Id = "303", DisplayName = "反抗的" });
		Add(new TalentDefinition { Id = "304", DisplayName = "気丈" });
		Add(new TalentDefinition { Id = "305", DisplayName = "貞操観念" });
		Add(new TalentDefinition { Id = "306", DisplayName = "解放" });
		Add(new TalentDefinition { Id = "307", DisplayName = "恥薄い" });
		Add(new TalentDefinition { Id = "308", DisplayName = "楽観的" });
		Add(new TalentDefinition { Id = "309", DisplayName = "好奇心" });
		Add(new TalentDefinition { Id = "310", DisplayName = "快感に素直" });
		Add(new TalentDefinition { Id = "311", DisplayName = "清楚" });
		Add(new TalentDefinition { Id = "312", DisplayName = "倹約家" });
		Add(new TalentDefinition { Id = "313", DisplayName = "乳自慢" });
		Add(new TalentDefinition { Id = "314", DisplayName = "生意気" });
		Add(new TalentDefinition { Id = "315", DisplayName = "目立ちたがり" });
		Add(new TalentDefinition { Id = "316", DisplayName = "感情豊か" });
		Add(new TalentDefinition { Id = "350", DisplayName = "プライド低い" });
		Add(new TalentDefinition { Id = "351", DisplayName = "卑屈" });
		Add(new TalentDefinition { Id = "352", DisplayName = "臆病" });
		Add(new TalentDefinition { Id = "353", DisplayName = "素直" });
		Add(new TalentDefinition { Id = "354", DisplayName = "弱気" });
		Add(new TalentDefinition { Id = "355", DisplayName = "貞操無頓着" });
		Add(new TalentDefinition { Id = "356", DisplayName = "抑圧" });
		Add(new TalentDefinition { Id = "357", DisplayName = "恥じらい" });
		Add(new TalentDefinition { Id = "358", DisplayName = "悲観的" });
		Add(new TalentDefinition { Id = "359", DisplayName = "無関心" });
		Add(new TalentDefinition { Id = "360", DisplayName = "快感の否定" });
		Add(new TalentDefinition { Id = "361", DisplayName = "粗野" });
		Add(new TalentDefinition { Id = "362", DisplayName = "浪費癖" });
		Add(new TalentDefinition { Id = "363", DisplayName = "乳責め嫌悪" });
		Add(new TalentDefinition { Id = "364", DisplayName = "大人しい" });
		Add(new TalentDefinition { Id = "365", DisplayName = "慎ましい" });
		Add(new TalentDefinition { Id = "366", DisplayName = "感情乏しい" });
		Add(new TalentDefinition { Id = "400", DisplayName = "気品" });
		Add(new TalentDefinition { Id = "401", DisplayName = "謙虚" });
		Add(new TalentDefinition { Id = "402", DisplayName = "一線越えない" });
		Add(new TalentDefinition { Id = "403", DisplayName = "自制心" });
		Add(new TalentDefinition { Id = "404", DisplayName = "献身的" });
		Add(new TalentDefinition { Id = "405", DisplayName = "自慰しやすい" });
		Add(new TalentDefinition { Id = "406", DisplayName = "嫉妬しやすい" });
		Add(new TalentDefinition { Id = "407", DisplayName = "見栄っ張り" });
		Add(new TalentDefinition { Id = "408", DisplayName = "保守的" });
		Add(new TalentDefinition { Id = "409", DisplayName = "ズボラ" });
		Add(new TalentDefinition { Id = "410", DisplayName = "サボり癖" });
		Add(new TalentDefinition { Id = "411", DisplayName = "倒錯的" });
		Add(new TalentDefinition { Id = "412", DisplayName = "ツンデレ" });
		Add(new TalentDefinition { Id = "413", DisplayName = "乳劣等感" });
		Add(new TalentDefinition { Id = "414", DisplayName = "サド" });
		Add(new TalentDefinition { Id = "415", DisplayName = "カリスマ" });
		Add(new TalentDefinition { Id = "416", DisplayName = "気分屋" });
		Add(new TalentDefinition { Id = "417", DisplayName = "正義感" });
		Add(new TalentDefinition { Id = "418", DisplayName = "乙女心" });
		Add(new TalentDefinition { Id = "419", DisplayName = "隷属願望" });
		Add(new TalentDefinition { Id = "420", DisplayName = "母性本能" });
		Add(new TalentDefinition { Id = "421", DisplayName = "チョロイン" });
		Add(new TalentDefinition { Id = "422", DisplayName = "信仰心" });
		Add(new TalentDefinition { Id = "423", DisplayName = "小悪魔" });
		Add(new TalentDefinition { Id = "424", DisplayName = "幼稚" });
		Add(new TalentDefinition { Id = "500", DisplayName = "牛好き" });
		Add(new TalentDefinition { Id = "501", DisplayName = "馬好き" });
		Add(new TalentDefinition { Id = "502", DisplayName = "犬好き" });
		Add(new TalentDefinition { Id = "503", DisplayName = "猫好き" });
		Add(new TalentDefinition { Id = "504", DisplayName = "ハムスター好き" });
		Add(new TalentDefinition { Id = "505", DisplayName = "羊好き" });
		Add(new TalentDefinition { Id = "520", DisplayName = "男好き" });
		Add(new TalentDefinition { Id = "521", DisplayName = "女好き" });
		Add(new TalentDefinition { Id = "522", DisplayName = "子供好き" });
		Add(new TalentDefinition { Id = "523", DisplayName = "貴族好き" });
		Add(new TalentDefinition { Id = "524", DisplayName = "王族好き" });
		Add(new TalentDefinition { Id = "525", DisplayName = "同族好き" });
		Add(new TalentDefinition { Id = "526", DisplayName = "天界族好き" });
		Add(new TalentDefinition { Id = "527", DisplayName = "魔族好き" });
		Add(new TalentDefinition { Id = "530", DisplayName = "お風呂好き" });
		Add(new TalentDefinition { Id = "531", DisplayName = "掃除好き" });
		Add(new TalentDefinition { Id = "532", DisplayName = "料理好き" });
		Add(new TalentDefinition { Id = "533", DisplayName = "読書好き" });
		Add(new TalentDefinition { Id = "534", DisplayName = "植物好き" });
		Add(new TalentDefinition { Id = "535", DisplayName = "機械好き" });
		Add(new TalentDefinition { Id = "536", DisplayName = "実験好き" });
		Add(new TalentDefinition { Id = "537", DisplayName = "おしゃれ好き" });
		Add(new TalentDefinition { Id = "550", DisplayName = "ミルク好き" });
		Add(new TalentDefinition { Id = "551", DisplayName = "洋菓子好き" });
		Add(new TalentDefinition { Id = "552", DisplayName = "和菓子好き" });
		Add(new TalentDefinition { Id = "553", DisplayName = "お酒好き" });
		Add(new TalentDefinition { Id = "554", DisplayName = "お茶好き" });
		Add(new TalentDefinition { Id = "555", DisplayName = "酸味好き" });
		Add(new TalentDefinition { Id = "556", DisplayName = "辛味好き" });
		Add(new TalentDefinition { Id = "557", DisplayName = "魚好き" });
		Add(new TalentDefinition { Id = "558", DisplayName = "肉好き" });
		Add(new TalentDefinition { Id = "559", DisplayName = "野菜好き" });
		Add(new TalentDefinition { Id = "600", DisplayName = "注射苦手" });
		Add(new TalentDefinition { Id = "610", DisplayName = "トラウマ／魔族" });
		Add(new TalentDefinition { Id = "611", DisplayName = "トラウマ／触手" });
		Add(new TalentDefinition { Id = "612", DisplayName = "トラウマ／ゴブリン" });
		Add(new TalentDefinition { Id = "613", DisplayName = "トラウマ／オーク" });
		Add(new TalentDefinition { Id = "614", DisplayName = "トラウマ／スライム" });
		Add(new TalentDefinition { Id = "615", DisplayName = "トラウマ／ワーム" });
		Add(new TalentDefinition { Id = "650", DisplayName = "ＪＳ" });
		Add(new TalentDefinition { Id = "651", DisplayName = "ＪＣ" });
		Add(new TalentDefinition { Id = "652", DisplayName = "ＪＫ" });
		Add(new TalentDefinition { Id = "653", DisplayName = "ＪＤ" });
		Add(new TalentDefinition { Id = "654", DisplayName = "現代道具知識" });
		Add(new TalentDefinition { Id = "655", DisplayName = "現代科学知識" });
		Add(new TalentDefinition { Id = "660", DisplayName = "天性のアイドル" });
		Add(new TalentDefinition { Id = "661", DisplayName = "総受け" });
		Add(new TalentDefinition { Id = "662", DisplayName = "主人公特権" });
}
	...
	private void SeedTrainingActions()
	{
		...
		private void SeedEquip()
	{
		// Clothing items from Equip.csv (real equipment, not slot IDs)
		Add(new ItemDefinition { Id = "equip_1400", DisplayName = "奴隷のボロ布", Category = ItemCategory.Equipment, Price = 30, Description = "奴隷のボロ布", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Slave });
		Add(new ItemDefinition { Id = "equip_1401", DisplayName = "踊り子の衣装", Category = ItemCategory.Equipment, Price = 200, Description = "踊り子の衣装", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1402", DisplayName = "逆バニー服", Category = ItemCategory.Equipment, Price = 200, Description = "逆バニー服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Bunny });
		Add(new ItemDefinition { Id = "equip_1403", DisplayName = "淫乱巫女服", Category = ItemCategory.Equipment, Price = 200, Description = "淫乱巫女服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "equip_1404", DisplayName = "淫乱シスター服", Category = ItemCategory.Equipment, Price = 200, Description = "淫乱シスター服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1405", DisplayName = "淫乱メイド服", Category = ItemCategory.Equipment, Price = 200, Description = "淫乱メイド服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid });
		Add(new ItemDefinition { Id = "equip_1406", DisplayName = "淫乱チャイナドレス", Category = ItemCategory.Equipment, Price = 200, Description = "淫乱チャイナドレス", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1407", DisplayName = "淫乱ドレス", Category = ItemCategory.Equipment, Price = 200, Description = "淫乱ドレス", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1450", DisplayName = "旅人の服", Category = ItemCategory.Equipment, Price = 30, Description = "旅人の服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1451", DisplayName = "ローブ", Category = ItemCategory.Equipment, Price = 30, Description = "ローブ", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1452", DisplayName = "貴族服", Category = ItemCategory.Equipment, Price = 200, Description = "貴族服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Formal });
		Add(new ItemDefinition { Id = "equip_1453", DisplayName = "巫女服", Category = ItemCategory.Equipment, Price = 200, Description = "巫女服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "equip_1454", DisplayName = "修道服", Category = ItemCategory.Equipment, Price = 200, Description = "修道服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1455", DisplayName = "法衣", Category = ItemCategory.Equipment, Price = 200, Description = "法衣", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1456", DisplayName = "忍装束", Category = ItemCategory.Equipment, Price = 200, Description = "忍装束", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Tactical });
		Add(new ItemDefinition { Id = "equip_1457", DisplayName = "戦闘用巫女服", Category = ItemCategory.Equipment, Price = 200, Description = "戦闘用巫女服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Exorcist });
		Add(new ItemDefinition { Id = "equip_1458", DisplayName = "戦闘用シスター服", Category = ItemCategory.Equipment, Price = 200, Description = "戦闘用シスター服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1459", DisplayName = "戦闘用メイド服", Category = ItemCategory.Equipment, Price = 200, Description = "戦闘用メイド服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Maid });
		Add(new ItemDefinition { Id = "equip_1460", DisplayName = "ビキニアーマー", Category = ItemCategory.Equipment, Price = 200, Description = "ビキニアーマー", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1461", DisplayName = "コート", Category = ItemCategory.Equipment, Price = 200, Description = "コート", Slot = EquipmentSlot.Coat, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1462", DisplayName = "魔術学園制服", Category = ItemCategory.Equipment, Price = 200, Description = "魔術学園制服", Slot = EquipmentSlot.Coat, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1463", DisplayName = "ドレス", Category = ItemCategory.Equipment, Price = 200, Description = "ドレス", Slot = EquipmentSlot.Coat, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1464", DisplayName = "バトルドレス", Category = ItemCategory.Equipment, Price = 200, Description = "バトルドレス", Slot = EquipmentSlot.Coat, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1490", DisplayName = "天界のローブ", Category = ItemCategory.Equipment, Price = 500, Description = "天界のローブ", Slot = EquipmentSlot.Coat, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1500", DisplayName = "ブルマ体操着", Category = ItemCategory.Equipment, Price = 120, Description = "ブルマ体操着", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1501", DisplayName = "シャツ＆ジーンズ", Category = ItemCategory.Equipment, Price = 120, Description = "シャツ＆ジーンズ", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1502", DisplayName = "ブラウス＆スカート", Category = ItemCategory.Equipment, Price = 120, Description = "ブラウス＆スカート", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1503", DisplayName = "割烹着", Category = ItemCategory.Equipment, Price = 120, Description = "割烹着", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1504", DisplayName = "囚人服", Category = ItemCategory.Equipment, Price = 120, Description = "囚人服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1505", DisplayName = "ゴスロリ衣装", Category = ItemCategory.Equipment, Price = 120, Description = "ゴスロリ衣装", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1506", DisplayName = "ディアンドル", Category = ItemCategory.Equipment, Price = 120, Description = "ディアンドル", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Formal });
		Add(new ItemDefinition { Id = "equip_1507", DisplayName = "ナース服", Category = ItemCategory.Equipment, Price = 120, Description = "ナース服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Nurse });
		Add(new ItemDefinition { Id = "equip_1508", DisplayName = "バニースーツ", Category = ItemCategory.Equipment, Price = 120, Description = "バニースーツ", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Bunny });
		Add(new ItemDefinition { Id = "equip_1509", DisplayName = "セーラー服", Category = ItemCategory.Equipment, Price = 120, Description = "セーラー服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.School });
		Add(new ItemDefinition { Id = "equip_1510", DisplayName = "チャイナドレス", Category = ItemCategory.Equipment, Price = 120, Description = "チャイナドレス", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1511", DisplayName = "アオザイ", Category = ItemCategory.Equipment, Price = 120, Description = "アオザイ", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1512", DisplayName = "着物", Category = ItemCategory.Equipment, Price = 120, Description = "着物", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1513", DisplayName = "ブレザー制服", Category = ItemCategory.Equipment, Price = 120, Description = "ブレザー制服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1514", DisplayName = "軍服", Category = ItemCategory.Equipment, Price = 120, Description = "軍服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1515", DisplayName = "ライダースーツ", Category = ItemCategory.Equipment, Price = 120, Description = "ライダースーツ", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1516", DisplayName = "パーカー", Category = ItemCategory.Equipment, Price = 120, Description = "パーカー", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1517", DisplayName = "カーディガン", Category = ItemCategory.Equipment, Price = 120, Description = "カーディガン", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1600", DisplayName = "ねこブラ", Category = ItemCategory.Equipment, Price = 80, Description = "ねこブラ", Slot = EquipmentSlot.UnderwearTop, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1601", DisplayName = "スポーツブラ", Category = ItemCategory.Equipment, Price = 80, Description = "スポーツブラ", Slot = EquipmentSlot.UnderwearTop, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1602", DisplayName = "縞パン", Category = ItemCategory.Equipment, Price = 80, Description = "縞パン", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1603", DisplayName = "Ｔバック", Category = ItemCategory.Equipment, Price = 80, Description = "Ｔバック", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1604", DisplayName = "Ｃストリング", Category = ItemCategory.Equipment, Price = 80, Description = "Ｃストリング", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1605", DisplayName = "キャミソール", Category = ItemCategory.Equipment, Price = 80, Description = "キャミソール", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1606", DisplayName = "レオタード", Category = ItemCategory.Equipment, Price = 80, Description = "レオタード", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Lingerie });
		Add(new ItemDefinition { Id = "equip_1607", DisplayName = "スリングショット", Category = ItemCategory.Equipment, Price = 80, Description = "スリングショット", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1608", DisplayName = "スクール水着", Category = ItemCategory.Equipment, Price = 80, Description = "スクール水着", Slot = EquipmentSlot.UnderwearBottom, ClothingStyleValue = ClothingStyle.Swimsuit });
		Add(new ItemDefinition { Id = "equip_1609", DisplayName = "バニーつけみみ", Category = ItemCategory.Equipment, Price = 80, Description = "バニーつけみみ", Slot = EquipmentSlot.Accessory, ClothingStyleValue = ClothingStyle.Bunny });
		Add(new ItemDefinition { Id = "equip_1610", DisplayName = "猫耳カチューシャ", Category = ItemCategory.Equipment, Price = 80, Description = "猫耳カチューシャ", Slot = EquipmentSlot.Ears, ClothingStyleValue = ClothingStyle.Casual });
		Add(new ItemDefinition { Id = "equip_1800", DisplayName = "触手服", Category = ItemCategory.Equipment, Price = 120, Description = "触手服", Slot = EquipmentSlot.Armor, ClothingStyleValue = ClothingStyle.Casual });
	}
	...
	private void Add(CharacterDefinition definition)
		{
				...
				OpenMakaiRanch.Gameplay.AdultEligibilityGate.ValidateAndSetEligibility(definition, definition.ApparentAge, definition.AgeContextNote);
