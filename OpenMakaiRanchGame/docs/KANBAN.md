...
- **CHAR-002** One master character source/context review and non-explicit identity references. Candidate only: Noir; no age/design clearance yet. Needs CHAR-001 (done) + DATA-003.
